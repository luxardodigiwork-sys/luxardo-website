    ...
    >
      <div className="max-w-md mx-auto px-6">
        <div className="text-center space-y-4 mb-12">
          <h1 className="text-4xl font-display">Login</h1>
          <p className="font-sans text-brand-secondary">Access your Luxardo account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input 
              ...
              placeholder="admin or alexander@luxury.com"
            />
            {fieldErrors.email && (
          ...
          <div className="flex items-center gap-3 pt-2">
            <input type="checkbox" id="remember" className="w-4 h-4 border-brand-divider rounded-none accent-brand-black cursor-pointer" />
            <label htmlFor="remember" className="text-xs font-sans text-brand-secondary cursor-pointer hover:text-brand-black transition-colors">Remember me for 30 days</label>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-brand-divider text-center space-y-6">
          <p className="text-sm font-sans text-brand-secondary">Don't have an account?</p>
          <Link to="/register" state={{ from: location.state?.from }} className="text-[11px] uppercase tracking-[0.25em] font-bold text-brand-black hover:opacity-60 transition-opacity">
            Create Account
          </Link>
        </div>
      </div>
