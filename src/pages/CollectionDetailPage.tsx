  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      ...
      <section className="relative h-[50vh] overflow-hidden bg-brand-black">
        ...
        />
        <div className="absolute inset-0 flex items-center justify-center text-brand-white text-center px-6">
          <motion.div
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-32 space-y-16">
                <div className="space-y-6">
                  <h2 className="text-base uppercase tracking-[0.3em] font-bold text-brand-black/40">The Narrative</h2>
                  <p className="text-3xl font-display leading-relaxed text-brand-black">
                    {collection?.narrative}
                  </p>
                </div>

                <div className="space-y-6">
                  <h2 className="text-base uppercase tracking-[0.3em] font-bold text-brand-black/40">Craftsmanship Note</h2>
                  <p className="text-lg font-sans leading-relaxed text-brand-secondary">
                    {collection?.craftsmanship}
                  </p>
                </div>

                <div className="space-y-6">
                  <h2 className="text-base uppercase tracking-[0.3em] font-bold text-brand-black/40">The Presentation</h2>
                  <p className="text-lg font-sans leading-relaxed text-brand-secondary">
                ...
                <div className="pt-8 border-t border-brand-divider">
                  <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-black/60">
                    Maison Luxardo &copy; 2026
                  </p>
                </div>
              </div>
            </div>
