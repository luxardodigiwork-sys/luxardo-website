  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-black">
      ...
      <section className="section-padding bg-brand-black text-brand-white text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center grayscale" />
