    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
      ...
      <form onSubmit={(e) => handleSubmit(e)} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 border border-brand-divider shadow-sm space-y-6">
            <h3 className="text-[11px] uppercase tracking-widest font-bold border-b border-brand-divider pb-4">Product Story & Description</h3>
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest font-bold text-brand-secondary">Description</label>
              <textarea
                rows={4}
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1 space-y-2">
                  <label className="text-[10px] uppercase tracking-widest font-bold text-brand-secondary">Primary Image URL</label>
                  <input
                    type="url"
                    required
              ...
              <div className="pt-6 border-t border-brand-divider">
                ...
                <div className="flex gap-2 mb-6">
                  <input
                    ...
                    className="flex-1 bg-brand-bg border border-brand-divider px-4 py-2 font-sans text-sm focus:outline-none focus:border-brand-black"
                  />
                  <button 
                    type="button"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 border border-brand-divider shadow-sm space-y-4">
            ...
            >
              {isLoading ? 'SAVING...' : <><Save size={16} /> Publish Product</>}
            </button>
          </div>
