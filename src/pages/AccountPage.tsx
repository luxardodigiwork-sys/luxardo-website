                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-brand-divider pb-6">
                              <div className="flex gap-8">
                                ...
                                <div className="space-y-1">
                                  ...
                                  <p className="font-sans text-brand-black">{formatINR(order.totalAmount)}</p>
                                </div>
                              </div>
                              <div className="flex gap-4">
                                <div className="space-y-1 text-right">
                                  <p className="text-[10px] uppercase tracking-widest font-bold text-brand-secondary">Payment</p>
                                  <p className="font-sans text-brand-black">Paid</p>
                                </div>
                                <div className="space-y-1 text-right">
