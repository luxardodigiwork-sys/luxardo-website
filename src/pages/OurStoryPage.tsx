    ...
    <div className="min-h-screen bg-brand-bg text-brand-black">
      ...
      <section className="section-padding text-center space-y-16">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-8">
          ...
          <Link to="/prime-membership" className="btn-secondary border border-brand-black px-16 py-6 text-[11px] uppercase tracking-[0.2em] font-bold hover:bg-brand-black hover:text-brand-white transition-all">
            REQUEST MEMBERSHIP
          </Link>
        </div>
      </section>
