  ...
  useEffect(() => {
    ...
    if (foundOrder) {
      ...
      const transformedOrder = {
        ...
        paymentStatus: 'Paid',
        total: formatINR(foundOrder.totalAmount),
        subtotal: formatINR(foundOrder.totalAmount), // Simplified
        shipping: formatINR(0),
        tax: formatINR(0),
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button 
                ...
                className="w-full py-4 border border-brand-black text-[11px] uppercase tracking-widest font-bold hover:bg-brand-black hover:text-brand-white transition-colors"
              >
                Track Order
              </button>
              ...
              <div className="relative">
                <button 
                  ...
                  className="w-full py-4 border border-brand-black bg-brand-black text-brand-white text-[11px] uppercase tracking-widest font-bold hover:bg-brand-white hover:text-brand-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              <div className="pt-4">
                {!showCancelConfirm ? (
                  <button 
                    ...
                    className="w-full py-4 border border-brand-divider text-brand-secondary text-[11px] uppercase tracking-widest font-bold hover:border-brand-black hover:text-brand-black transition-colors"
                  >
                    Cancel Order
                  </button>
                ) : (
                  <motion.div 
                    ...
                    className="space-y-4 bg-brand-white p-6 border border-brand-divider"
                  >
                    <p className="text-sm font-sans text-brand-black text-center">Are you sure you want to cancel this order?</p>
                    <div className="flex gap-4">
                      <button 
                        onClick={() => setShowCancelConfirm(false)}
                        className="flex-1 py-3 border border-brand-black text-brand-black text-[11px] uppercase tracking-widest font-bold hover:bg-brand-black hover:text-brand-white transition-colors"
                      >
                        No, Keep It
                      </button>
                      <button 
                        onClick={handleCancelOrder}
                        className="flex-1 py-3 bg-brand-black border border-brand-black text-brand-white text-[11px] uppercase tracking-widest font-bold hover:bg-brand-white hover:text-brand-black transition-colors"
                      >
                        Yes, Cancel
                      </button>
                    </div>
