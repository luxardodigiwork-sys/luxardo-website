              ...
              <div key={item.product.id} className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center py-8 border-b border-brand-divider">
                <div className="col-span-1 md:col-span-6 flex gap-8">
                  ...
                  <div className="flex flex-col justify-center space-y-3">
                    ...
                    <button onClick={() => removeFromCart(item.product.id)} className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-secondary hover:text-brand-black transition-colors text-left flex items-center gap-2 mt-4">
                ...
                <div className="col-span-1 md:col-span-3 flex justify-between md:justify-center items-center">
                  ...
                  <div className="flex items-center border border-brand-divider bg-brand-white">
                    <button onClick={() => updateQuantity(item.product.id, -1)} className="p-4 hover:bg-brand-divider transition-colors"><Minus className="w-4 h-4" /></button>
                    <span className="w-12 text-center font-sans font-medium">{item.quantity}</span>
                    <button onClick={() => updateQuantity(item.product.id, 1)} className="p-4 hover:bg-brand-divider transition-colors"><Plus className="w-4 h-4" /></button>
                  </div>
                </div>
            ...
            <div className="bg-brand-white p-10 border border-brand-divider space-y-10 sticky top-32">
              ...
              <div className="space-y-6 font-sans text-brand-secondary">
                <div className="flex justify-between">
                  ...
                  <span className="text-brand-black font-medium">{formatINR(displaySubtotal)}</span>
                </div>
                <div className="flex justify-between">
