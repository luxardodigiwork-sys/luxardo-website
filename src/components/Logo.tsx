...
export const Logo: React.FC<LogoProps> = ({ className = '', as: Component = 'div', variant = 'default', dark = false }) => {
  ...
  return (
    <motion.img 
      ...
      src="https://www.luxardofashion.in/Img/LOGOn.png" 
      alt="LUXARDO" 
      className={`object-contain h-auto grayscale brightness-0 ${dark ? 'invert' : ''} ${variant === 'large' ? 'w-full max-w-6xl opacity-[0.03]' : ''} ${className}`}
